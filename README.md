...
2. In HACS, go to Integrations and search for "Vestel ECV04 Wallbox".
3. Install the integration.
4. Restart Home Assistant.
5. Add the integration via the UI: Settings > Devices & Services > Add Integration > Vestel ECV04 Wallbox.
